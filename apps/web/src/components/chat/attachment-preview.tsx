...
import {
  FileIcon, FileTextIcon, FileCodeIcon, FileImageIcon, FilePdfIcon, FileXlsIcon,
  FileDocIcon, FileZipIcon, FileAudioIcon, FileVideoIcon, DownloadSimpleIcon,
} from '@phosphor-icons/react';
import type { MessageAttachment } from '@monokeros/types';
import { formatFileSize, getExt, CODE_EXTS, TEXT_EXTS, IMAGE_EXTS, SPREADSHEET_EXTS, DOC_EXTS, ARCHIVE_EXTS, AUDIO_EXTS, VIDEO_EXTS } from '@monokeros/utils';
