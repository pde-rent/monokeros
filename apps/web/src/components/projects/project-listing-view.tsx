...
import { PlusIcon, SquaresFourIcon, TableIcon, ArrowsOutIcon, PencilSimpleIcon } from '@phosphor-icons/react';
  ...
  return (
    <Group orientation="horizontal" className="h-full">
      ...
      >
        ...
        >
          <FilterPanelShell search={search} onSearchChange={setSearch} searchPlaceholder="Search projects...">
            <FilterSection>
              <div className="px-2">
                ...
                <div key={project.id} className="group relative">
                  <button
                    ...
                    className={`w-full rounded-md border p-4 text-left transition-all hover:border-edge-hover ${
                      selectedProjectId === project.id ? 'border-blue bg-blue-light' : 'border-edge bg-elevated'
                    }`}
              ...
              {scored.map(({ project, matched }) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      <span className="text-xs text-fg-2">{formatLabel(project.currentPhase)}</span>
                    </td>
                    <td className="px-3 py-2">
      ...
      {projectsPopout.isOpen && projectsPopout.render(
