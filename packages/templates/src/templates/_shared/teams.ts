...
export const pmTeam = (): TeamManifest =>
  team("product-management", "Product Management", "management", "#8b5cf6", "pm-lead", [
    "pm-analyst",
  ]);
...
export const accountingTeam = (): TeamManifest =>
  team("accounting", "Accounting", "operations", "#6b7280", "accounting-lead", [
    "accounting-analyst",
  ]);
...
export const webDevTeam = (): TeamManifest =>
  team("development", "Web Development", "engineering", "#3b82f6", "frontend-lead", [
    "backend-dev",
    "fullstack-dev",
  ]);

export const seoTeam = (): TeamManifest =>
  team("seo-sea", "SEO/SEA", "marketing", "#10b981", "seo-lead", [
    "sea-specialist",
    "content-strategist",
  ]);

export const webDesignTeam = (): TeamManifest =>
  team("design", "UI/UX Design", "design", "#ec4899", "design-lead", [
    "ux-designer",
    "web-designer",
  ]);
...
export const mobileDevTeam = (): TeamManifest =>
  team("mobile-dev", "Mobile Development", "engineering", "#3b82f6", "mobile-lead", [
    "ios-dev",
    "android-dev",
    "flutter-dev",
  ]);
...
export const litigationTeam = (): TeamManifest =>
  team("litigation", "Litigation", "legal", "#ef4444", "litigation-lead", [
...
export const complianceTeam = (): TeamManifest =>
  team("compliance", "Compliance & Research", "legal", "#f59e0b", "compliance-officer", [
    "legal-researcher",
  ]);
...
export const trendTeam = (): TeamManifest =>
  team("trend-identification", "Trend Identification", "research", "#6366f1", "trend-analyst", [
    "data-scout",
  ]);

export const deepResearchTeam = (): TeamManifest =>
  team("deep-research", "Deep Research", "research", "#8b5cf6", "research-lead", [
    "source-auditor",
  ]);
...
export const contentDevTeam = (): TeamManifest =>
  team("content-dev", "Dev (Blog Platform)", "engineering", "#3b82f6", "content-dev-lead", [
    "content-frontend-dev",
  ]);

export const publishingOpsTeam = (): TeamManifest =>
  team("publishing-ops", "Publishing Ops", "operations", "#f59e0b", "ops-lead", [
...
export const advertisementTeam = (): TeamManifest =>
  team("advertisement", "Advertisement", "marketing", "#f97316", "ad-lead", [
