...
export const TASK_STATUS_COLUMNS: { status: TaskStatus; label: string }[] = Object.values(
  TaskStatus,
).map((status) => ({ status, label: TASK_STATUS_LABELS[status] }));
...
export const WORKSPACE_INDUSTRIES: Record<WorkspaceIndustry, IndustryPreset> = {
  ...
  [WorkspaceIndustry.MARKETING_COMMUNICATIONS]: {
    ...
    icon: "megaphone",
    subtypes: mapSubtypes(WorkspaceIndustry.MARKETING_COMMUNICATIONS, [
      /\bpr comms\b/,
      "PR & Communications",
    ]),
    defaultTeams: [
  ...
  [WorkspaceIndustry.TRANSLATION_LOCALIZATION]: {
    ...
    defaultTeams: [
      ...
      { name: "review-editing", type: "review", displayName: "Review & Editing", color: "#f59e0b" },
      {
        ...
        type: "engineering",
        displayName: "Localization Engineering",
        color: "#10b981",
      },
  ...
  [WorkspaceIndustry.HEALTHCARE_LIFE_SCIENCES]: {
    ...
    icon: "heart-pulse",
    subtypes: mapSubtypes(WorkspaceIndustry.HEALTHCARE_LIFE_SCIENCES, [
      /\bhealth it\b/,
      "Health IT",
    ]),
    defaultTeams: [
  ...
  [WorkspaceIndustry.EDUCATION_TRAINING]: {
    ...
    icon: "graduation-cap",
    subtypes: mapSubtypes(
      WorkspaceIndustry.EDUCATION_TRAINING,
      [/\bk12\b/, "K-12"],
      [/\bhigher ed\b/, "Higher Education"],
    ),
    defaultTeams: [
...
export const DEFAULT_LLM_BASE_URL = "https://api.z.ai/api/coding/paas/v4";
export const DEFAULT_LLM_MODEL = "glm-5";
export const DEFAULT_LLM_TYPE = "openai_compat";
...
export { MODEL_PRICING, estimateCost } from "./model-pricing";
