...
export const CODE_EXTS = new Set([
  ...
  'cs', 'swift', 'kt', 'php', 'vue', 'svelte', 'scala', 'scss', 'sass', 'less',
  'css', 'html', 'hpp', 'lua', 'r', 'pl', 'ex', 'exs', 'erl', 'hs', 'ml',
  'clj', 'dart', 'zig', 'nim', 'v', 'sol', 'sql', 'sh', 'bash', 'zsh',
]);

export const TEXT_EXTS = new Set([
  'txt', 'md', 'markdown', 'rst', 'log', 'cfg', 'conf', 'ini', 'yaml', 'yml',
  'json', 'xml', 'toml', 'env',
]);
...
export const SPREADSHEET_EXTS = new Set([
  'xls', 'xlsx', 'csv', 'tsv', 'ods', 'parquet', 'avro', 'orc',
]);
